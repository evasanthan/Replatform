...
//    @EJB(mappedName="java:app/spring-ejb3-webapp/BlogPostDaoBean")
    private final BlogPostDaoBean blogPostDao;
    private final SpamFilterService spamFilterService;

    public BlogPostController(BlogPostDaoBean blogPostDao,SpamFilterService spamFilterService){
...
//    private SpamFilterService spamFilterService;
     ...
     */
    @RequestMapping(value = "/blogposts/new", method= RequestMethod.GET)
